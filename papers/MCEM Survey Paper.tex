...
Consider the problem of gene frequency estimation. That is, we seek to estimate the frequencies of different alleles for a particular gene based on a sample of phenotypes. We follow Example 2.4 from \citet{McL08}.
...
\begin{appendices}
    ...
    In this appendix, we present details for the analysis of our linear regression example with a single, unobserved, covariate. See Section \ref{sec:eg-genes} for formulation of the model and definition of notation.
