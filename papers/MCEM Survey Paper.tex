...
In this section, we give a brief overview of importance sampling, with a focus on how it can be applied to the MCEM algorithm. We point to several references where the interested reader can find more details (see especially the references contained therein).
