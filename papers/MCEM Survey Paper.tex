...
\begin{figure}
    ...
    \subfloat[Estimate trajectories]{\includegraphics[width = 0.75\textwidth]{../plots/Blood_Type/Chan_Ledolter_Traj.pdf} \label{fig2:blood_CL_MCEM_estimates}}

    \subfloat[Estimated log-likelihood ratio trajectory]{\includegraphics[width = 0.75\textwidth]{../plots/Blood_Type/Chan_Ledolter_lik_ratio_Traj.pdf} \label{fig2:blood_CL_MCEM_likelihoods}}   
\end{figure}
