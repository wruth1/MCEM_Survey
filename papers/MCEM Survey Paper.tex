...
We illustrate all the the MCEM algorithms and related methods on a running example. Computation for these analyses is done in \texttt{Julia} \citep{Bez17}. Our code is available in a GitHub repository \citep{Rut23I}.
...
\begin{figure}
    ...
    \subfloat[\citet{Dey99}]{\includegraphics[width = 0.75\textwidth]{../plots/Blood_Type/SAEM_Traj_obj_fun.pdf} \label{fig:blood_SAEM_traj_obj_fun}}   
