...
\begin{appendices}
    ...
    %
    \begin{align}
        \bE(n_O|y) &= 2y_1 + \frac{2 y_2 pr}{p^2 + 2pr} + \frac{2 y_3 qr}{q^2 + 2qr}\\
        &= 2y_1 + 2 y_2 \left( \frac{\rho_2}{\rho_2 + \rho_3} \right) + 2 y_3 \left( \frac{\rho_4}{\rho_4 + \rho_5} \right) &\left( = 2y_1 + 2 y_2 \left( \frac{\rho_2}{\pi_2} \right) + 2 y_3 \left( \frac{\rho_4}{\pi_3} \right) \right)\\
        \bE(n_A|y) &= \frac{2 y_2 pr}{p^2 + 2pr} + \frac{2y_2 p^2}{p^2 + 2pr} + y_4\\
        &= 2y_2 \left( \frac{\rho_2}{\rho_2 + \rho_3} + \frac{\rho_3}{\rho_2 + \rho_3} \right) + y_4 &\left(= 2y_2 \left( \frac{\rho_2}{\pi_2} + \frac{\rho_3}{\pi_2} \right) + y_4 \right)\\
        &= y_2 \left( 1 + \frac{p^2}{p^2 + 2pr} \right) + y_4\\
        \bE(n_B|y) &= \frac{2 y_3 qr}{q^2 + 2qr} + \frac{2y_3 q^2}{q^2 + 2qr} + y_4\\
        &= 2y_3 \left( \frac{\rho_4}{\rho_4 + \rho_5} + \frac{\rho_5}{\rho_4 + \rho_5} \right) + y_4 &\left(= 2y_3 \left( \frac{\rho_4}{\pi_3} + \frac{\rho_5}{\pi_3} \right) + y_4 \right)\\
